...
from module.GA2019.powerlaw import *
from module.GA2019.stats import pval_from_score
from module.GA2019.stats import xdata_to_xnx
...
def fit_power_cont_func(a, xmin, xmax, D):
    ...
    if xmax == np.inf:
        ...
        return D + 1. / (1. - gamma) - (np.log(xmax) * xmax ** (1. - gamma) - np.log(xmin) * xmin ** (1. - gamma)) / (
                xmax ** (1. - gamma) - xmin ** (1. - gamma))
